...
export default function Footer() {
    return (
        <footer className="bg-krit flex flex-col">
            <div className="max-w-screen-2xl mx-auto w-screen px-6 lg:px-12 py-12 flex-1 flex flex-col justify-between">
                
                {/* MOBILE LAYOUT */}
                <div className="lg:hidden flex flex-col h-full justify-between gap-12">
                ...
                {/* DESKTOP LAYOUT */}
                <div className="hidden lg:flex lg:flex-col h-full gap-12">
                    {/* Top Section */}
